...
import GetAllList from "@/views/pages/admin/menu/GetAllList.vue"
import GetAllMajorCategories from '@/services/major_categories/GetAllMajorCategory'
...
export default {
  ...
  setup(props, { emit }) {
    const { load_finder } = GetAllMajorCategories()
